                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input id="kode_departemen" type="text"
                                        ...
                                        name="kode_departemen" value="{{ old('kode_departemen') }}" required autofocus
                                        maxlength="10" placeholder="Contoh: IT, HR, FIN" style="text-transform: uppercase;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="nama_departemen" type="text"
                                        ...
                                        name="nama_departemen" value="{{ old('nama_departemen') }}" required maxlength="100"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan"
                                        rows="3" maxlength="500" placeholder="Deskripsi atau keterangan tambahan tentang departemen (opsional)">{{ old('keterangan') }}</textarea>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info mb-0">
                            ...
                            <ul class="mb-0">
                                <li><strong>Kode Departemen:</strong> Gunakan singkatan yang mudah diingat (IT, HR, FIN,
                                    OPS, dll)</li>
                                ...
                                <li><strong>Status Aktif:</strong> Hanya departemen aktif yang bisa digunakan untuk
                                    pengadaan</li>
                            </ul>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            keteranganInput.addEventListener('input', function() {
                ...
                keteranganCounter.className =
                    `form-text float-end ${remaining < 50 ? 'text-danger' : 'text-muted'}`;
            });
